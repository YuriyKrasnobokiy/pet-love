import{u as a,b as j,r as g,j as e,I as b,aa as x,N as q,a as B,P as W,c as C,Q as E,G as T,ab as F,ac as c,ad as D,L as M,ae as V,af as G,ag as O}from"./index-DeNX3Fe9.js";import{C as Y}from"./CustomSelect-C2oDYHwP.js";const H="/pet-love/assets/add-pet-img-2x-desc-BVx0esE-.jpg",K="/pet-love/assets/add-pet-img-2x-tablet-BWjZlK6j.jpg",Q="/pet-love/assets/add-pet-img-2x-mob-Bz61LxfA.jpg",Z=a.div`
  display: grid;
...
`,me=({watch:t,register:d,errors:s})=>{var r;const n=j(),[p,o]=g.useState(null),i=t("imgURL"),u=()=>{if(!i){o(null);return}o(i.trim())};return g.useEffect(()=>{i!=null&&i.trim()||o(null)},[i]),e.jsxs(de,{children:[e.jsx(pe,{$imgPreview:p,children:p?null:e.jsx(b,{width:n==="desktop"||n==="tablet"?44:34,height:n==="desktop"||n==="tablet"?44:34,name:"icon-paw"})}),e.jsxs(le,{children:[e.jsx(ce,{...d("imgURL"),name:"imgURL",placeholder:"Enter URL",type:"text"}),e.jsxs(xe,{type:"button",onClick:u,children:["Upload photo ",e.jsx(b,{width:n==="desktop"||n==="tablet"?18:16,height:n==="desktop"||n==="tablet"?18:16,name:"icon-cloud"})]}),e.jsx(x,{className:"addPet photo",children:(r=s.imgURL)==null?void 0:r.message})]})]})};function he(t){return q({tag:"svg",attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"rect",attr:{width:"18",height:"18",x:"3",y:"4",rx:"2",ry:"2"},child:[]},{tag:"line",attr:{x1:"16",x2:"16",y1:"2",y2:"6"},child:[]},{tag:"line",attr:{x1:"8",x2:"8",y1:"2",y2:"6"},child:[]},{tag:"line",attr:{x1:"3",x2:"21",y1:"10",y2:"10"},child:[]}]})(t)}const ge=()=>{var v,k,P,$,S;const t=B(),d=W(),s=C(E);console.log("profile: ",s);const n=C(T),[p,o]=g.useState(null),i=()=>{d("/profile")},u=F().shape({title:c().required("Title is required"),name:c().required("Pet's name is required"),imgURL:c().matches(/^https?:\/\/.*\.(?:png|jpg|jpeg|gif|bmp|webp)$/,"Invalid image URL").required("Image URL is required"),species:c().required("Species is required"),birthday:c().matches(/^\d{4}-\d{2}-\d{2}$/,"Date must be in YYYY-MM-DD format").required("Birthday is required"),sex:c().required("Sex is required")}),{register:r,handleSubmit:R,setValue:w,watch:y,reset:A,formState:{errors:l}}=D({defaultValues:{title:"",name:"",imgURL:"",species:"",birthday:"",sex:""},resolver:V(u)}),N=async m=>{try{console.log("Valid form data:",m),t(G(m)),A(),o(null),d("/profile")}catch(U){console.log(U)}};return g.useEffect(()=>{t(M())},[t]),e.jsxs(J,{onSubmit:R(N),children:[e.jsxs(X,{children:["Add my pet /",e.jsx(_,{children:"Personal details"})]}),e.jsxs(h,{children:[e.jsx(re,{register:r,setValue:w,watch:y}),e.jsx(x,{className:"addPet",children:(v=l.sex)==null?void 0:v.message})]}),e.jsx(me,{watch:y,register:r,errors:l}),e.jsxs(ee,{children:[e.jsxs(h,{children:[e.jsx(f,{...r("title"),name:"title",placeholder:"Title",type:"text"}),e.jsx(x,{className:"addPet",children:(k=l.title)==null?void 0:k.message})]}),e.jsxs(h,{children:[e.jsx(f,{...r("name"),name:"name",placeholder:"Pet’s Name",type:"text"}),e.jsx(x,{className:"addPet",children:(P=l.name)==null?void 0:P.message})]}),e.jsxs(te,{children:[e.jsxs(h,{children:[e.jsx(ie,{children:e.jsx(he,{})}),e.jsx(f,{...r("birthday"),className:"date",name:"birthday",placeholder:"0000-00-00",type:"text"}),e.jsx(x,{className:"addPet",children:($=l.birthday)==null?void 0:$.message})]}),e.jsxs(h,{children:[e.jsx(Y,{addPet:!0,options:n,placeholder:"Pet type",handleOptionChange:m=>{w("species",m.value,{shouldValidate:!0}),o(m)},selectedOpt:p}),e.jsx(x,{className:"addPet",children:(S=l.species)==null?void 0:S.message})]})]})]}),e.jsxs(ae,{children:[e.jsx(z,{type:"button",onClick:i,className:"back",children:"Back"}),e.jsx(z,{type:"submit",className:"submit",children:"Submit"})]})]})},be=()=>{const t=j();return e.jsxs(Z,{className:"container",children:[e.jsx(O,{imageUrl:t==="desktop"?H:t==="tablet"?K:Q}),e.jsx(ge,{})]})};export{be as default};
