import{u as a,a as B,c as F,r as $,P as y,j as t,I as g,Q as I,b as S}from"./index-DpkvdkQU.js";const W=a.form`
  position: relative;
  margin: 0 auto;
...
`,P=({onFetch:e,onPageChange:n,isInFilters:r,setFilterTerm:p,selectFilterTerm:x})=>{const s=B(),c=F(x),[l,d]=$.useState(c||""),[i,w]=y();$.useEffect(()=>{const o=i.get("filterWord")||"";d(o),o!==c&&(s(p(o)),e({page:1,limit:6,filterWord:o}))},[i,s,c]);const m=o=>{const u=new URLSearchParams(i.toString());o?u.set("filterWord",o):u.delete("filterWord"),w(u)},j=o=>{o.preventDefault(),m(l),s(p(l)),n(1),e({page:1,limit:6,filterWord:l})},k=o=>{o.preventDefault(),m(""),d(""),s(p("")),n(1),e({page:1,limit:6,filterWord:""})},v=o=>{d(o.target.value)};return t.jsxs(W,{$isInFilters:r,onSubmit:j,children:[t.jsx(z,{type:"text",placeholder:"Search",value:l,onChange:v,$isInFilters:r}),l!==""&&t.jsx(M,{type:"button",onClick:k,children:t.jsx(g,{height:18,width:18,name:"icon-cross-small"})}),t.jsx(R,{type:"submit",children:t.jsx(g,{height:18,width:18,name:"icon-search"})})]})};function f(e){return I({tag:"svg",attr:{fill:"none",viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{strokeLinecap:"round",strokeLinejoin:"round",d:"M13 5l7 7-7 7M5 5l7 7-7 7"},child:[]}]})(e)}function b(e){return I({tag:"svg",attr:{fill:"none",viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{strokeLinecap:"round",strokeLinejoin:"round",d:"M9 5l7 7-7 7"},child:[]}]})(e)}const D=a.div`
  display: flex;
