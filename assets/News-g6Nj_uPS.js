...
`,A=({currentPage:t,totalPages:s,onPageChange:n})=>e.jsxs(q,{children:[e.jsx(a,{disabled:t===1,onClick:()=>n(t=1),children:e.jsx(c,{name:"icon-arrow",width:20,height:20})}),e.jsx(a,{disabled:t===1,onClick:()=>n(t-1),children:e.jsx(c,{name:"icon-arrow",width:20,height:20})}),e.jsx(a,{disabled:t===1,onClick:()=>n(t=1),children:"1"}),e.jsx(a,{disabled:t>2,onClick:()=>n(t=2),children:"2"}),e.jsx(a,{disabled:!0,children:"..."}),e.jsx(a,{disabled:t===s,onClick:()=>n(t+1),children:e.jsx(c,{name:"icon-arrow",width:20,height:20})}),e.jsx(a,{disabled:t===s,onClick:()=>n(t=s),children:e.jsx(c,{name:"icon-arrow",width:20,height:20})})]}),H=()=>{const t=w(),s=i(b),n=i(S),d=s.filter(l=>l.title.toLowerCase().includes(n.toLowerCase())),h=i(C);i(N);const p=i(y),r=i(k),x=i($);f.useEffect(()=>{t(g({page:p,limit:r}))},[t,p,r]);const u=l=>{t(g({page:l,limit:r}))};return e.jsx(e.Fragment,{children:h?e.jsx(j,{}):e.jsxs(E,{className:"container",children:[e.jsx(R,{className:"title",children:"News"}),e.jsx(Y,{}),e.jsx(W,{children:d.map(l=>e.jsx(z,{nw:l},l._id))}),x>1?e.jsx(A,{currentPage:p,totalPages:x,onPageChange:u}):null]})})};export{H as default};
